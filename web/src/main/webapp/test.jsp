...
<html>
<head>
<title>Прикольный IQ-тест</title>
</head>
<body onload="    var v_date_init = new Date();
    tm_init = v_date_init.getTime(); test_tm();">
...
<div class="ui-widget">
    ...
    <div class="mys_total">
        ...
        <h1 class="breadcrumb">
            <a href="/tests/iq_humor.php" class="nowrap">Прикольный IQ-тест</a>
        </h1>
        <div class="clear_both"></div>
        <form action="/tests/iq_humor.php" method="post" id="form_test"><div>
            <input type="hidden" name="tm" value="1270368063" />
            ...
            <ul>
                ...
                <li><input type="radio" name="test[7]" value="3" id="test_7_4"  /> <label for="test_7_3">89</label></li>
            </ul>
            <div class="question">
